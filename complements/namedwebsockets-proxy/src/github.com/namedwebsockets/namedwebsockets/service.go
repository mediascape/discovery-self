...
func GetNamedWebSockets(service *NamedWebSocket_Service, socket *NamedWebSocket, servicePath string){
	socket = service.namedWebSockets[servicePath]
}
func SetNamedWebSockets(service *NamedWebSocket_Service, socket *NamedWebSocket, servicePath string){
	service.namedWebSockets[servicePath] = socket
}
