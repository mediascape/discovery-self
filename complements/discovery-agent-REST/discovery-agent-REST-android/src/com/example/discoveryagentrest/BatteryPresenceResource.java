...
public class BatteryPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "BatteryPresence");
		try {
			JSONObject mainObj = new JSONObject();
			if(ServiceBoot.batterySensor) mainObj.put("presence", true);
			else mainObj.put("presence", false);
			if(getReference().getRemainingPart().contains("callback")) answer="presenceBattery("+mainObj.toString()+")";
