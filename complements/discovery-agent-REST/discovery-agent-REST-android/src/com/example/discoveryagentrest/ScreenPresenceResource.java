...
public class ScreenPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "ScreenPresence");
		try {
			JSONObject mainObj = new JSONObject();
			if(ServiceBoot.screenWidth!=0 && ServiceBoot.screenHeight!=0) mainObj.put("presence", true);
			else mainObj.put("presence", false);
			if(getReference().getRemainingPart().contains("callback")) answer="presenceScreen("+mainObj.toString()+")";
