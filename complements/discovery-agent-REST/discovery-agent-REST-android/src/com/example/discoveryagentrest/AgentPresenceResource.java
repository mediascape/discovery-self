...
public class AgentPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "AgentPresence");
		try {
			JSONObject mainObj = new JSONObject();
			mainObj.put("presence", true);
			if(getReference().getRemainingPart().contains("callback")) answer="presenceAgent("+mainObj.toString()+")";
