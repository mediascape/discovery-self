...
public class OrientationExtraResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "OrientationExtra");
		try {
			JSONObject mainObj = new JSONObject();
			JSONArray ja = new JSONArray();
			JSONObject jo = new JSONObject();
			if(ServiceBoot.orientationSensor!=null){
				Log.d("MyApp", ServiceBoot.getRotation(ServiceBoot.context));
				jo.put("orientation", ServiceBoot.getRotation(ServiceBoot.context));
				ja.put(jo);
				mainObj.put("extra", ja);
			}else{
				mainObj.put("extra", "Error geting orientation information.");
			}

			if(getReference().getRemainingPart().contains("callback")) answer="extraOrientation("+mainObj.toString()+")";
