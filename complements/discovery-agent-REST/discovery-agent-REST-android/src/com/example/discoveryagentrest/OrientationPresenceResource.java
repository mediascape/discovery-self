...
public class OrientationPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "OreintationPresence");
		try {
			JSONObject mainObj = new JSONObject();
			if(ServiceBoot.orientationSensor!=null) mainObj.put("presence", true);
			else mainObj.put("presence", false);
			if(getReference().getRemainingPart().contains("callback")) answer="presenceOrientation("+mainObj.toString()+")";
