...
public class TouchscreenPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "TouchScreenPresence");
		try {
			JSONObject mainObj = new JSONObject();
			Log.d("MyApp", "touchscreen: "+ServiceBoot.touchScreenSensor);
			if(ServiceBoot.touchScreenSensor){
				mainObj.put("presence", true);
			}else{
				mainObj.put("presence", false);
			}
			if(getReference().getRemainingPart().contains("callback")) answer="presenceTouchscreen("+mainObj.toString()+")";
