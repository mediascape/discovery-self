...
public class VibrationPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "vibrationPresence");
		try {
			JSONObject mainObj = new JSONObject();
			if(ServiceBoot.vibratorSensor) mainObj.put("presence", "true");
			else mainObj.put("presence", "false");
			if(getReference().getRemainingPart().contains("callback")) answer="presenceVibration("+mainObj.toString()+")";
