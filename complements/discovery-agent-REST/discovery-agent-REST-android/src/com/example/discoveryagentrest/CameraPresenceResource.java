...
public class CameraPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "CameraPresence");
		try {
			JSONObject mainObj = new JSONObject();
			if(ServiceBoot.batterySensor) mainObj.put("presence", true);
			else mainObj.put("presence", false);
			if(getReference().getRemainingPart().contains("callback")) answer="presenceCamera("+mainObj.toString()+")";
