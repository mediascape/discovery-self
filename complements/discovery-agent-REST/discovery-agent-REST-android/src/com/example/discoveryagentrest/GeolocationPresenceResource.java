...
public class GeolocationPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "GeolocationPresence");
		try {
			JSONObject mainObj = new JSONObject();
			if(ServiceBoot.gpsSensor) mainObj.put("presence", true);
			else mainObj.put("presence", false);
			if(getReference().getRemainingPart().contains("callback")) answer="presenceGeolocation("+mainObj.toString()+")";
