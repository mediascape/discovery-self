...
public class UpnpPresenceResource extends ServerResource {
	/*
	 * toString
	 * 
    ...
    public Representation doGet() {
		...
		String answer="";
		Log.d("MyApp", "UPnPPresence");
		try {
				JSONObject mainObj = new JSONObject();
				mainObj.put("presence", true);
				if(getReference().getRemainingPart().contains("callback")) answer="presenceUpnp("+mainObj.toString()+")";
